...
test('settings and backtest views expose operational controls and traceable result metadata', () => {
  ...
  assert.match(operations, /createFundamentalSyncRun/)
  assert.match(operations, /pauseFundamentalSyncRun/)
  assert.match(operations, /listFundamentalVerificationTargets/)
  assert.match(operations, /blockingDifferences/)
