...
const locale = {
  ...
  'trading-bot.pageSubtitle': 'Tạo và quản lý các chiến lược mẫu',
  ...
  'trading-bot.noBots': 'Chưa có chiến lược mẫu — chọn thẻ phía trên để tạo',
...
'indicatorIde.editor.fastLessThanSlow': 'Fast line parameter must be less than slow line parameter',
  ...
  'trading-bot.martingale.waterfallProtection': 'Chống sập (tạm dừng nhồi lệnh)',
  'trading-bot.martingale.waterfallProtectionHint': 'Tạm dừng lệnh đầu và nhồi lệnh khi giảm mạnh; TP/SL vẫn hoạt động.',
  'trading-bot.martingale.waterfallDropPct': '% drawdown kích hoạt',
  'trading-bot.martingale.waterfallDropPctHint': 'Tạm dừng khi giá giảm % này so với đỉnh gần nhất (mặc định 4%).',
  ...
  'request.forbiddenDesc': 'Bạn không có quyền thực hiện thao tác này.',
  'request.unauthorizedTitle': 'Chưa xác thực',
  ...
  'systemOverview.strategyStartNotPersisted': 'Chiến lược không duy trì trạng thái đang chạy. Hãy mở chiến lược để kiểm tra nhật ký chạy.',
  ...
  'community.yourPurchasePrice': 'Giá tôi mua',
  ...
  'indicatorIde.quality.PARAM_DEFAULT_MISMATCH': 'Giá trị mặc định của tham số không khớp: {details}. Hãy để mặc định trong # @param khớp chính xác với fallback trong params.get(..., default), nếu không biểu đồ, backtest và live có thể dùng các giá trị khác nhau.',
  ...
  'adminAiStats.copilotMessages': 'Tin nhắn Copilot',
  ...
  'adminAiStats.colCopilotSessions': 'Cuộc trò chuyện',
  ...
  // Author Dashboard (English fallback - awaiting Vietnamese translation)
