...
const locale = {
  ...
  "aiAssetAnalysis.copilot.strategyPrompt.scriptStarter": "Create an executable trading strategy for {target} with entry, exit, risk, and position-sizing rules. Encode conservative defaults in ScriptStrategy parameters and metadata; return code only.",
  "aiAssetAnalysis.copilot.strategyPrompt.scriptStarterWithIdea": "Create an executable trading strategy for {target}. My idea: {idea}\nComplete entry, exit, risk, and position rules with conservative ScriptStrategy parameters and metadata; return code only.",
  ...
  "strategyCenter.card.signal.title": "Script Strategy",
  "strategyCenter.card.signal.desc": "Pick an indicator and bind an account to run signals or live trading",
  "strategyCenter.card.signal.suit": "Best for: Python ScriptStrategy with ctx order methods",
  "strategyCenter.card.signal.action": "Create script strategy",
  "strategyCenter.card.signal.secondary": "No indicator yet? Open Indicator IDE →",
  "strategyCenter.card.script.badge": "Python",
  "strategyCenter.card.script.title": "Script Strategy",
  ...
  "strategyCenter.card.script.action": "Create script strategy",
  ...
  "strategyCenter.header.createIndicatorStrategy": "Create script strategy",
  "strategyCenter.header.createScriptStrategy": "Create trading script",
  ...
  "strategyCenter.library.indicatorStrategies": "Script strategies",
  "strategyCenter.library.scriptStrategies": "Script strategies",
  ...
  "strategyCenter.stats.indicatorStrategy": "Script strategies",
  ...
  "strategyCenter.flowHintDesc": "Indicators are chart-only; use ScriptStrategy for custom execution, and use dedicated executors for grid, DCA, and martingale workflows.",
  ...
  "trading-bot.cloneAsScript.gridPlaceholderHint": "Grid bots execute via the live resting-order engine; the cloned script is only a placeholder (on_bar: pass). Rewrite on_bar in Strategy Studio for custom logic, or clone a martingale/trend/DCA bot for a full template.",
  ...
  "strategyCenter.live.noBacktestContent": "This script strategy has no successful backtest. Run a backtest first, or start live anyway?",
  ...
  "community.useScriptStrategy": "Open strategy",
  ...
  "aiAssetAnalysis.copilot.scriptStrategyDesc": "Generate Python ScriptStrategy for complex logic and automated execution.",
  ...
  "dashboard.indicator.backtest.running": "Running ScriptStrategy backtest...",
  ...
  "dashboard.indicator.backtest.executionAssumptions.bodyScriptStandard": "Script strategy backtest: on_bar runs on each closed bar at the strategy timeframe; orders from the script are filled at the next bar open by default (plus slippage/fees). This is not the indicator strict/non-strict toggle — it is the standard script replay path.",
  ...
  "dashboard.indicator.backtest.executionAssumptions.tradeCountScriptNote": "Script backtest replays on_bar bar-by-bar; trade count follows script orders plus platform fill rules (default: next-bar open).",
  ...
  "backtest-center.subtitle": "Run ScriptStrategy backtests, inspect history, and review execution results.",
  ...
  "backtest-center.config.signalTimingHelp": "ScriptStrategy execution is driven by the strategy code and selected K-line timeframe.",
  ...
  "dashboard.setupGuide.desc": "Script strategies and template strategies share this performance overview. Create and start a strategy to aggregate positions, fills, and returns here.",
  ...
  "trading-assistant.scriptLiveNotSupportedHint": "Script strategies run on each completed K-line through on_bar and use the ScriptStrategy order API.",
  ...
  "trading-assistant.strategyType.IndicatorStrategy": "Script Strategy",
  ...
  "trading-assistant.form.riskFromIndicatorInfo": "Risk, sizing, timeframe, and execution rules now belong in ScriptStrategy code. Indicators are chart-only and cannot drive backtests or live orders.",
  "trading-assistant.form.riskFromIndicatorMissingWarn": "No ScriptStrategy source was detected for this setup. Create or select a script strategy before live execution.",
  ...
  "trading-assistant.form.simpleModePresetValue": "Starts with 15m / Futures / 5x. Configure TP/SL and position sizing in ScriptStrategy code.",
  "trading-assistant.form.simpleModeSectionCore": "Core trading setup",
  "trading-assistant.form.simpleModeSectionCoreDesc": "Finish pair and capital settings first, then decide whether to enable live trading; risk lives in ScriptStrategy code.",
  ...
  "trading-assistant.form.indicatorStrategy": "Script Strategy",
  "trading-assistant.form.indicatorStrategyDesc": "Python ctx ScriptStrategy for backtesting and live execution",
  ...
  "trading-assistant.messages.indicatorStrategyRemoved": "Indicators are chart-only and cannot run live. Please create a script strategy.",
  "trading-assistant.messages.scriptStrategyOnly": "Executable strategies now use ScriptStrategy only.",
  ...
  "trading-assistant.positions.noSpotPositions": "No spot positions",
  ...
  "trading-assistant.strategyTypeOptions.indicator": "Script Strategy",
  ...
  "settings.desc.BILLING_COST_AI_INDICATOR_TO_STRATEGY": "Credits consumed each time AI converts a chart-only indicator into an executable script strategy.",
  ...
  "trading-assistant.createIndicatorStrategy": "Create script strategy",
  "trading-assistant.createScriptStrategy": "Create script strategy",
  "trading-assistant.pageBanner.signal.badge": "Script Strategy",
  "trading-assistant.pageBanner.signal.desc": "Indicators are chart-only source material; use ScriptStrategy for live execution",
  ...
  "trading-assistant.strategyMode.signalDesc": "Indicators only render chart overlays and labels. Convert visible logic to a Python ScriptStrategy before backtesting or live trading.",
  ...
  "trading-assistant.strategyMode.signalFeature3": "Use ScriptStrategy for risk, sizing, and execution",
  ...
  "trading-assistant.selectModeHint": "Create executable Python ScriptStrategy code, or start from a database template.",
  ...
  "trading-assistant.editor.codeParamsDesc": "Detected from ctx.param(...) and # @strategy risk annotations in the current script. Adjust values here and apply them back to the code.",
  ...
  "trading-assistant.editor.aiHint": "Pick a template first, then adjust strategy parameters. The run panel owns symbol, direction, investment amount, and leverage.",
  ...
  "trading-assistant.editor.aiSuggestionImprovePrompt": "Improve the current script structure and logs. Keep symbol, direction, investment amount, and leverage controlled by the run panel, not ctx.param.",
  "trading-assistant.editor.aiSuggestionRisk": "Add better risk control",
  "trading-assistant.editor.aiSuggestionRiskPrompt": "Add more complete take-profit, stop-loss, layer limits, and cooldown protection. Use ctx.basket notional sizing for orders.",
  ...
  "trading-assistant.editor.aiPromptTemplateHint": "Continue optimizing this template while keeping symbol/direction/investment/leverage in the run panel:",
  ...
  "dashboard.indicator.publish.hideCodeHint": "When enabled, buyers cannot view source code in the editor. The system can still run the chart indicator; backtests and live trading require converting it to a script strategy first.",
  ...
  "indicatorIde.structuredTuneExplain": "Indicator tuning optimizes chart parameters only. Convert to ScriptStrategy before batch-testing stop-loss, take-profit, sizing, or execution parameters.",
  ...
  "indicatorIde.hiddenCodeDesc": "You can run the chart indicator and adjust available parameters in the parameter panel. Backtesting and live trading require converting it to a script strategy first.",
  ...
  "indicatorIde.quality.MISSING_BUY_SELL_COLUMNS": "Legacy df['buy']/df['sell'] columns are ignored. Indicators are chart-only; convert to ScriptStrategy for execution.",
  "indicatorIde.quality.UNKNOWN_STRATEGY_KEY": "Unknown @strategy key \"{key}\" (ignored by parser)",
  "indicatorIde.quality.EXECUTION_COLUMNS_IGNORED_FOR_INDICATOR": "Indicators are chart-only. Open/close/add/reduce columns are not executed. Generate a script strategy before backtesting or live trading.",
  ...
  "indicatorIde.indicatorBacktestRemoved": "Indicators are chart-only. Generate a script strategy before backtesting.",
  "indicatorIde.generateScriptStrategyHint": "AI Copilot is ready to convert this indicator into a script strategy for later backtesting or live trading.",
  ...
  "indicatorIde.structuredTuneHint": "Indicator candidate parameters can feed ScriptStrategy generation; run strategy batch backtests from the ScriptStrategy backtest page.",
  ...
  "indicatorIde.bestParamsApplied": "Candidate values written into indicator code (# @param). Indicators are chart-only; convert to ScriptStrategy before backtesting or live trading.",
  ...
  "indicatorIde.strategyAnnotationsHint": "This indicator has @strategy lines; they are used as engine-risk hints only after conversion to ScriptStrategy.",
  "indicatorIde.strategyFromCodeHint": "Indicator code is chart-only. Put stop-loss, take-profit, sizing, and execution rules in ScriptStrategy code.",
  ...
  "indicatorIde.strategyDirectives.alertDesc": "# @strategy annotations are engine-risk hints only after conversion to ScriptStrategy. Indicators themselves do not backtest, trade live, or place orders.",
  ...
  "trading-assistant.strategyAnnotation.entryPct.desc": "Share of the run-panel investment amount used for each entry.",
  "trading-assistant.strategyAnnotation.stopLossPct.desc": "Engine-managed stop-loss ratio used by backtests and live review.",
  "trading-assistant.strategyAnnotation.takeProfitPct.desc": "Engine-managed take-profit ratio used by backtests and live review.",
  "trading-assistant.strategyAnnotation.trailingEnabled.desc": "Whether engine-managed trailing stop logic is enabled.",
  "trading-assistant.strategyAnnotation.trailingStopPct.desc": "Price retracement from favorable movement required to trigger the trailing stop.",
  "trading-assistant.strategyAnnotation.trailingActivationPct.desc": "Profit ratio required before the trailing stop becomes active.",
  "trading-assistant.strategyAnnotation.maxHoldingBars.label": "Max holding bars",
  "trading-assistant.strategyAnnotation.maxHoldingBars.desc": "Maximum holding bars before engine-managed exit; 0 disables it.",
...
export default {
  ...
  "trading-assistant.editor.ctaBlankTemplateDesc": "Start from the CTA on_bar(ctx, bar) contract.",
  ...
  "universeLibrary.copyReference": "Copy reference",
  "universeLibrary.selected": "Selected",
  "universeLibrary.use": "Use in strategy",
  "universeLibrary.codeReference": "Strategy reference",
  ...
  "strategyIde.paramDesc": "Automatically reads ctx.param(...) and @strategy risk annotations from the current script. Adjust values here and write them back to code.",
  ...
  "strategyIde.templateIntroDesc": "Start from a blank script, or use a database template. Symbol, market type, direction, capital and leverage are selected in the run panel.",
  "strategyIde.blankScript": "Blank script",
  "strategyIde.blankScriptDesc": "Only on_init / on_bar skeleton, write logic freely",
  ...
  "strategyIde.indicatorConvertBoundary": "The conversion creates script strategy code. Symbol, capital, market type, leverage and direction are still configured in the run panel.",
  ...
  "strategyIde.verifyHints.legacySignal": "Legacy signal-style APIs are no longer supported. Use ctx ScriptStrategy order APIs.",
  "strategyIde.verifyHints.forbiddenApi": "Unsupported API detected: {names}.",
  "strategyIde.verifyHints.noBarAccess": "on_bar should read bar data or ctx.bars(...) before trading.",
  ...
  "strategyIde.verifyHints.CTX_PARAM_MISSING_DEFAULT": "ctx.param(...) is missing a default value on line {count}. Declare parameters in on_init.",
  "strategyIde.verifyHints.CTX_PARAM_RUN_PANEL_FIELD": "The run-panel field should not be declared as ctx.param: {names}.",
  "strategyIde.verifyHints.INDICATOR_OUTPUT_CONTRACT": "Indicator output contracts are no longer supported for strategy execution. Use ctx ScriptStrategy APIs.",
  "strategyIde.verifyHints.MISSING_ON_INIT": "Missing on_init(ctx).",
  "strategyIde.verifyHints.MISSING_ON_BAR": "Missing on_bar(ctx, bar).",
  ...
  "menu.dashboard.portfolioDeployments": "Portfolio Robots",
  "portfolioDeployment.kicker": "Portfolio automation",
  "portfolioDeployment.title": "Portfolio Robots",
  "portfolioDeployment.subtitle": "Deploy standard portfolio strategy code to notification or Alpaca Paper execution.",
  "portfolioDeployment.reload": "Reload",
  "portfolioDeployment.config": "Deployment configuration",
  "portfolioDeployment.source": "Portfolio strategy",
  "portfolioDeployment.universe": "Universe",
  "portfolioDeployment.frequency": "Rebalance frequency",
  "portfolioDeployment.daily": "Daily",
  "portfolioDeployment.weekly": "Weekly",
  "portfolioDeployment.monthly": "Monthly",
  "portfolioDeployment.mode": "Execution mode",
  "portfolioDeployment.notifyOnly": "Notify only",
  "portfolioDeployment.live": "Live",
  "portfolioDeployment.credential": "Broker credential",
  "portfolioDeployment.credentialPlaceholder": "Select Alpaca Paper credential",
  "portfolioDeployment.liveHint": "Live portfolio execution currently supports US-stock universes through Alpaca Paper.",
  "portfolioDeployment.capital": "Reference capital",
  "portfolioDeployment.maxWeight": "Maximum weight (%)",
  "portfolioDeployment.commission": "Commission (%)",
  "portfolioDeployment.fractional": "Fractional shares",
  "portfolioDeployment.create": "Create portfolio robot",
  "portfolioDeployment.instances": "Deployment instances",
  "portfolioDeployment.empty": "No portfolio robots yet",
  "portfolioDeployment.runNow": "Run now",
  "portfolioDeployment.start": "Start schedule",
  "portfolioDeployment.stop": "Stop",
  "portfolioDeployment.status.running": "Running",
  "portfolioDeployment.status.stopped": "Stopped",
  "portfolioDeployment.status.error": "Error",
  "portfolioDeployment.created": "Portfolio robot created.",
  "portfolioDeployment.runQueued": "Rebalance evaluation completed.",
  "portfolioDeployment.loadFailed": "Failed to load portfolio robots.",
  "portfolioDeployment.createFailed": "Failed to create portfolio robot.",
  "portfolioDeployment.actionFailed": "Failed to update portfolio robot.",
  "portfolioDeployment.runFailed": "Portfolio rebalance failed.",
  "portfolioDeployment.symbols": "symbols",
  "portfolioDeployment.rebalanceHistory": "Rebalance history",
  "portfolioDeployment.noPlans": "No rebalance plans yet",
  "portfolioDeployment.equity": "Equity",
  "portfolioDeployment.cash": "Cash",
  "portfolioDeployment.buy": "Buy",
  "portfolioDeployment.sell": "Sell",
  "portfolioDeployment.executed": "Executed",
  "portfolioDeployment.skipped": "Skipped",
  "portfolioDeployment.orderStatus.notified": "Awaiting confirmation",
  "portfolioDeployment.orderStatus.user_executed": "Executed",
  "portfolioDeployment.orderStatus.user_skipped": "Skipped",
  "portfolioDeployment.orderStatus.queued": "Queued",
  "portfolioDeployment.loadPlansFailed": "Failed to load rebalance history.",
  "portfolioDeployment.acknowledged": "Execution acknowledgement saved.",
  "portfolioDeployment.ackFailed": "Failed to save execution acknowledgement.",
