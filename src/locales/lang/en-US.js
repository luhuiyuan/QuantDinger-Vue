...
export default {
  ...
  "settings.marketHistory.title": "A-share history operations",
  "settings.marketHistory.description": "Inspect durable daily history, provider health, coverage quality, and controlled sync runs.",
  "settings.marketHistory.refresh": "Refresh",
  "settings.marketHistory.historyFeature": "History feature",
  "settings.marketHistory.syncFeature": "Sync feature",
  "settings.marketHistory.provider": "Provider",
  "settings.marketHistory.selectedNode": "Selected node",
  "settings.marketHistory.diskProtection": "Disk protection",
  "settings.marketHistory.freeDisk": "Free disk",
  "settings.marketHistory.coveredSymbols": "Covered symbols",
  "settings.marketHistory.completeRaw": "Complete raw coverage",
  "settings.marketHistory.adminOnly": "Administrator permission is required for market history operations.",
  "settings.marketHistory.backendDisabled": "The backend has not enabled A-share history sync. Status is unavailable and sync controls are disabled.",
  "settings.marketHistory.backendUnsupported": "This backend version does not provide A-share history operations. Upgrade the backend to use this panel.",
  "settings.marketHistory.loadFailed": "Market history status could not be loaded. No health or coverage state is being assumed.",
  "settings.marketHistory.diskBlocked": "New sync runs are blocked by disk protection.",
  "settings.marketHistory.diskAction": "Free disk space manually, then refresh. No project or Docker data is deleted automatically.",
  "settings.marketHistory.providerNodes": "Provider nodes",
  "settings.marketHistory.noProviderData": "No provider probes have been recorded.",
  "settings.marketHistory.healthy": "Healthy",
  "settings.marketHistory.unhealthy": "Unavailable",
  "settings.marketHistory.selected": "Selected",
  "settings.marketHistory.targetedSync": "Targeted sync",
  "settings.marketHistory.startSync": "Start sync",
  "settings.marketHistory.syncRuns": "Sync runs",
  "settings.marketHistory.coverageDetail": "Instrument coverage",
  "settings.marketHistory.query": "Query",
  "settings.marketHistory.complete": "Complete",
  "settings.marketHistory.incomplete": "Incomplete",
  "settings.marketHistory.missing": "Missing",
  "settings.marketHistory.blocking": "Blocking",
  "settings.marketHistory.issues": "Gaps and quality issues",
  "settings.marketHistory.enabled": "Enabled",
  "settings.marketHistory.disabled": "Disabled",
  "settings.marketHistory.node": "Node",
  "settings.marketHistory.status": "Status",
  "settings.marketHistory.latency": "Latency",
  "settings.marketHistory.failures": "Failures",
  "settings.marketHistory.lastChecked": "Last checked",
  "settings.marketHistory.lastSuccess": "Last success",
  "settings.marketHistory.range": "Range",
  "settings.marketHistory.progress": "Progress",
  "settings.marketHistory.currentInstrument": "Current instrument",
  "settings.marketHistory.lastError": "Last error",
  "settings.marketHistory.createdAt": "Created",
  "settings.marketHistory.actions": "Actions",
  "settings.marketHistory.retry": "Retry",
  "settings.marketHistory.cancel": "Cancel",
  "settings.marketHistory.expected": "Expected",
  "settings.marketHistory.actual": "Actual",
  "settings.marketHistory.syncCreated": "Sync run created",
  "settings.marketHistory.retryCreated": "Retry run created.",
  "settings.marketHistory.cancelled": "Run cancelled.",
  "strategyV2.cnHistory.title": "A-share history coverage is incomplete",
  "strategyV2.cnHistory.description": "The strategy was not executed. Complete and validate every requested and warm-up range before retrying.",
  "strategyV2.cnHistory.availableThrough": "Available through",
  "strategyV2.cnHistory.requestedRange": "Requested range",
  "strategyV2.cnHistory.warmupRange": "Warm-up range",
  "strategyV2.cnHistory.syncRange": "Suggested sync",
  "strategyV2.cnHistory.adminHint": "Ask an administrator to run a targeted sync from Settings → Market Data. The backtest never fills these gaps from a remote fallback.",
  "strategyV2.cnHistory.ruleVersion": "Market rules",
  "strategyV2.cnHistory.settlement": "Settlement",
  "strategyV2.cnHistory.lotSize": "Buy lot",
  "strategyV2.cnHistory.minimumCommission": "Minimum commission",
  "strategyV2.cnHistory.provenanceTitle": "Data provenance",
  "strategyV2.cnHistory.provenanceHint": "Provider, content, adjustment, factor, coverage, and cutoff are stored with this run.",
  "strategyV2.cnHistory.dataVersion": "Data version",
  "strategyV2.cnHistory.factorVersion": "Factor version",
  "strategyV2.cnHistory.adjustmentMode": "Adjustment",
  "menu.dashboard.cnStocks": "A-Share Market",
  "cnStocks.eyebrow": "Shanghai & Shenzhen",
  "cnStocks.title": "A-Share Market",
  "cnStocks.subtitle": "Explore market breadth, stocks, daily bars, and technical indicators.",
  "cnStocks.detailTitle": "A-Share Detail",
  "cnStocks.refresh": "Refresh",
  "cnStocks.staleTitle": "Cached market data is being shown",
  "cnStocks.unavailable": "Unavailable",
  "cnStocks.totalAmount": "Total turnover",
  "cnStocks.advancing": "Advancing",
  "cnStocks.declining": "Declining",
  "cnStocks.flat": "Unchanged",
  "cnStocks.limitUp": "Limit up",
  "cnStocks.limitDown": "Limit down",
  "cnStocks.searchPlaceholder": "Search by code or name",
  "cnStocks.allExchanges": "All exchanges",
  "cnStocks.shanghai": "Shanghai",
  "cnStocks.shenzhen": "Shenzhen",
  "cnStocks.allChanges": "All changes",
  "cnStocks.stock": "Stock",
  "cnStocks.exchange": "Exchange",
  "cnStocks.latest": "Latest",
  "cnStocks.changePercent": "Change %",
  "cnStocks.volume": "Volume",
  "cnStocks.amount": "Turnover",
  "cnStocks.quoteStatus": "Quote status",
  "cnStocks.quoteAvailable": "Available",
  "cnStocks.actions": "Actions",
  "cnStocks.addWatchlist": "Add to watchlist",
  "cnStocks.removeWatchlist": "Remove",
  "cnStocks.watchlistAdded": "Added to watchlist",
  "cnStocks.watchlistRemoved": "Removed from watchlist",
  "cnStocks.operationFailed": "Operation failed",
  "cnStocks.loadFailed": "Failed to load A-share market data",
  "cnStocks.hundredMillion": "100M CNY",
  "cnStocks.tenThousand": "10K",
  "cnStocks.freshness.fresh": "Near real-time",
  "cnStocks.freshness.stale": "Cached quote",
  "cnStocks.freshness.closedDaily": "Closed daily bars",
  "cnStocks.freshness.closed": "Market closed quote",
  "cnStocks.freshness.partial": "Partial page quotes",
  "cnStocks.freshness.unavailable": "Unavailable",
  "cnStocks.quoteCoverage": "Quote coverage {covered}/{total}",
  "cnStocks.refreshRunWarning": "Background quote refresh was incomplete",
  "cnStocks.refreshRunSummary": "Status: {status}; updated: {succeeded}/{planned}. Older valid quotes were retained.",
  "cnStocks.sort.symbol": "Sort by symbol",
  "cnStocks.sort.name": "Sort by name",
  "cnStocks.sort.changePercent": "Sort by change %",
  "cnStocks.sort.volume": "Sort by volume",
  "cnStocks.sort.amount": "Sort by turnover",
  "cnStocks.sort.quoteTime": "Sort by quote time",
  "cnStocks.sort.asc": "Ascending",
  "cnStocks.sort.desc": "Descending",
  "cnStocks.backToMarket": "Back to market",
  "cnStocks.openBacktest": "Open backtest",
  "cnStocks.open": "Open",
  "cnStocks.high": "High",
  "cnStocks.low": "Low",
  "cnStocks.previousClose": "Previous close",
  "cnStocks.quoteUnavailableTitle": "Quote unavailable",
  "cnStocks.quoteUnavailableDesc": "The stock identity remains available. Refresh the near real-time quote later.",
  "cnStocks.dailyChart": "Daily bars & volume",
  "cnStocks.dailyChartHint": "Daily bars and near real-time quotes use different timestamps.",
  "cnStocks.authoritativeHistory": "Authoritative local history",
  "cnStocks.displayHistory": "Display-only history",
  "cnStocks.historyFallbackTitle": "Using display-only daily bars",
  "cnStocks.historyFallbackDesc": "Local authoritative coverage is incomplete. This data is for display and cannot bypass backtest coverage checks.",
  "cnStocks.historyUnavailable": "No daily history available",
  "cnStocks.provider": "Provider",
  "cnStocks.lastTradeDate": "Last trade date",
  "cnStocks.dataVersion": "Data version",
  "cnStocks.technicalIndicators": "Technical indicators",
  ...
  "externalRequestLogs.logId": "Log ID",
  "externalRequestLogs.time": "Time",
  "externalRequestLogs.provider": "Provider",
  "externalRequestLogs.domain": "Domain",
  "externalRequestLogs.operation": "Operation",
  "externalRequestLogs.callingFeature": "Calling feature",
  "externalRequestLogs.requestId": "Request ID",
  "externalRequestLogs.result": "Result",
  "externalRequestLogs.duration": "Duration",
  "externalRequestLogs.features.notRecorded": "Not recorded",
  "externalRequestLogs.features.market_quote": "Market quotes",
  "externalRequestLogs.features.market_kline": "Market K-line data",
  "externalRequestLogs.features.global_market": "Global market",
  "externalRequestLogs.features.macro_data": "Macro data",
  "externalRequestLogs.features.economic_calendar": "Economic calendar",
  "externalRequestLogs.features.symbol_catalog_sync": "Trading-pair catalog sync",
  "externalRequestLogs.features.cn_fundamental_history": "A-share fundamental history",
  "externalRequestLogs.features.cn_fundamental_verification": "A-share fundamental verification",
  "strategyCenter.positionOwnership.summary": "Account and strategy positions are ledgered separately; protect manual inventory here.",
  ...
  "strategyCenter.positionOwnership.unknownQty": "Unknown delta",
  "strategyCenter.positionOwnership.mode": "Mode",
  "strategyCenter.positionOwnership.status": "Status",
  "strategyCenter.positionOwnership.normal": "Normal",
  "strategyCenter.positionOwnership.blocked": "Entry paused",
  "strategyCenter.positionOwnership.advanced": "Advanced",
  "strategyCenter.positionOwnership.strict": "Strict",
  "strategyCenter.positionOwnership.protectManual": "Protect as manual",
  "strategyCenter.positionOwnership.protectConfirm": "Record account quantity minus strategy allocation as protected manual inventory and enable advanced coexistence for this leg?",
  "strategyCenter.positionOwnership.useStrict": "Use strict mode",
  "strategyCenter.positionOwnership.strictConfirm": "Strict mode clears the protected baseline. Extra account inventory will keep new entries paused.",
  "strategyCenter.positionOwnership.recheck": "Recheck",
  "strategyCenter.positionOwnership.loadFailed": "Failed to load position ownership",
  "strategyCenter.positionOwnership.repairSuccess": "Position ownership updated",
  "strategyCenter.positionOwnership.repairFailed": "Position ownership repair failed"
}
