...
const locale = {
  ...
  'menu.dashboard.aiAssetAnalysis': 'AI Smart Analysis',
  'menu.dashboard.aiQuant': 'AI Quant',
  'menu.dashboard.indicator': 'Charts & Indicators',
  'menu.dashboard.community': 'Strategy Market',
  'menu.dashboard.tradingAssistant': 'Indicator Strategies',
  'menu.dashboard.backtestCenter': 'Backtest Center',
  'menu.dashboard.indicatorIde': 'Indicator IDE',
  'menu.dashboard.strategyIde': 'Strategy Chart Workbench',
  'menu.dashboard.tradingBot': 'Template Strategy',
  'menu.dashboard.brokerAccounts': 'Broker Accounts',
  'menu.dashboard.scriptStrategies': 'Script Strategies',
  'menu.dashboard.strategyCenter': 'Live Monitor',
  'strategyCenter.title': 'Live Monitor',
  'strategyCenter.subtitle': 'Monitor indicator, script, and template strategies in one place: live status, positions, and PnL',
  'strategyCenter.card.signal.badge': 'No code',
  'strategyCenter.card.signal.title': 'Indicator Strategy',
  'strategyCenter.card.signal.desc': 'Pick an indicator and bind an account to run signals or live trading',
  'strategyCenter.card.signal.suit': 'Best for: RSI / MACD / MA crossovers and signal alerts',
  'strategyCenter.card.signal.action': 'Create indicator strategy',
  ...
  'strategyCenter.header.createIndicatorStrategy': 'Create indicator strategy',
  'strategyCenter.header.createScriptStrategy': 'Create script strategy',
  ...
  'strategyCenter.library.indicatorStrategies': 'Indicator strategies',
  ...
  'strategyCenter.stats.indicatorStrategy': 'Indicator',
  ...
  'strategyCenter.flowHintDesc': 'Validate signals in Indicator IDE → create an indicator strategy; need stateful logic → script strategy; common patterns → template strategy.',
  ...
  'strategyCenter.backtest.typeIndicator': 'Indicator strategy',
  ...
  'community.useScriptStrategy': 'Open script strategy',
  'community.useNow': 'Use now',
  'community.free': 'Free',
  'community.paidOnly': 'Paid',
  'community.scriptTemplatePurchased': 'Purchase complete. A script strategy was created for you.',
  'community.purchaseSuccess': 'Purchase successful',
  ...
  "aiAssetAnalysis.copilot.indicatorStrategy": "Strategy Lab",
  "aiAssetAnalysis.copilot.indicatorStrategyDesc": "Create research, code, and backtest plans that land in Strategy Lab.",
  ...
  "aiAssetAnalysis.copilot.quickTasks.indicator_strategy.label": "Strategy Lab",
  "aiAssetAnalysis.copilot.quickTasks.indicator_strategy.desc": "Generate a strategy draft that can be reviewed, backtested, and published.",
  ...
  "aiAssetAnalysis.copilot.quickTasks.debug_logs.label": "Debug logs",
  "aiAssetAnalysis.copilot.quickTasks.debug_logs.desc": "Locate strategy, bot, and API errors.",
  ...
  'dashboard.setupGuide.desc': 'Indicator strategies, script strategies, and template strategies share this overview. Create and start one from the workspace to see positions, trades, and performance here.',
  'dashboard.setupGuide.path': 'Path: Live Monitor → pick a type (Indicator / Script / Template Strategy) → start Live',
  ...
  'trading-assistant.form.scriptStepParams': 'Strategy parameters',
  ...
  'trading-assistant.form.scriptSource': 'Script source',
  'trading-assistant.form.scriptSourceTitle': 'Choose a script source',
  'trading-assistant.form.scriptSourceHint': 'Pick a saved script from Strategy IDE. Symbol, timeframe, capital, live account, and notifications are configured in the next steps.',
  'trading-assistant.form.scriptSourcePlaceholder': 'Select a saved script',
  'trading-assistant.form.scriptSourceRequired': 'Select a script source first',
  'trading-assistant.form.scriptSourceCodeMissing': 'The selected script has no usable code',
  'trading-assistant.form.scriptSourceLoadFailed': 'Failed to load script source',
  ...
  'trading-assistant.messages.crossSectionalCreateSuccess': 'Cross-sectional strategy created',
  ...
  'trading-assistant.positions.strategyLedger': 'Strategy positions',
  ...
  // Indicator Community
  'community.title': 'Strategy Market',
  ...
  'trading-assistant.createIndicatorStrategy': 'Create indicator strategy',
  'trading-assistant.createScriptStrategy': 'Create script strategy',
  'trading-assistant.pageBanner.signal.badge': 'Indicator Strategy · IndicatorStrategy',
  'trading-assistant.pageBanner.signal.desc': 'Bind indicator signals to run; risk params live in # @strategy directives inside the indicator',
  ...
  'trading-assistant.editor.codeParamsDesc': 'Detected from ctx.param(...) in the current script. Adjust values here and apply them back to the code.',
  ...
  'trading-assistant.editor.paramsHint': 'Percent parameters use 0–100 (e.g. 80 means 80%). Click "Apply to Code" after changes to sync defaults into the script.',
  ...
  'quickTrade.spotBuyOnlyHint': 'Spot supports buy only here; sell from the holdings card on the right.',
  ...
  'trading-assistant.templateParam.hard_stop_pct.desc': 'Loss percentage that triggers an immediate full close; 2.5 means 2.5%.',
  'trading-assistant.templateParam.trailing_stop_pct.label': 'Trailing distance',
  'trading-assistant.templateParam.trailing_stop_pct.desc': 'Pullback from peak before trailing stop triggers; 1.5 means 1.5%.',
  'trading-assistant.templateParam.trailing_arm_pct.label': 'Trailing arm threshold',
  'trading-assistant.templateParam.trailing_arm_pct.desc': 'Unrealised profit required before trailing activates; 2 means 2%.',
  'trading-assistant.templateParam.entry_pct.label': 'Per-entry size',
  'trading-assistant.templateParam.entry_pct.desc': 'Percent of equity for each scale-in layer; 25 means 25%.',
  'trading-assistant.templateParam.dip_step_pct.label': 'Layer step',
  'trading-assistant.templateParam.dip_step_pct.desc': 'Price drop (percent) before adding the next layer; 2 means 2%.',
  ...
  'brokerAccounts.cryptoSection.subtitle': 'These accounts are stored as encrypted credentials in the database and used by template strategies and live strategies. Supports Binance / OKX / Bybit / HTX / Bitget / Coinbase / Kraken / KuCoin / Gate.io / Bitfinex.',
  ...
  // Profile — Agent Token (self-service)
...
const copilotI18nPatch = {
  ...
  "aiAssetAnalysis.copilot.quickTools": "Quick tools",
  "aiAssetAnalysis.copilot.hideQuickTools": "Hide quick tools",
  "aiAssetAnalysis.copilot.selectSymbolFirst": "Select a symbol to analyze first.",
  "aiAssetAnalysis.copilot.thinking": "Thinking...",
  ...
  "aiAssetAnalysis.copilot.quickTasks.indicator_strategy.label": "Strategy R&D",
  ...
  "aiAssetAnalysis.copilot.quickTasks.news_research.label": "News / event search",
  ...
  "aiAssetAnalysis.copilot.strategyExampleCode": "Code from idea",
  "aiAssetAnalysis.copilot.strategyExamples.momentum": "{symbol} 15m momentum breakout: go long when ROC > 0 and volume breaks above average, hold above EMA10, use 10x leverage, stop loss 2%, take profit 5%, backtest 6 months.",
  "aiAssetAnalysis.copilot.strategyExamples.reversal": "{symbol} 1h Bollinger reversal: short at upper band with RSI > 70, long at lower band with RSI < 30, exit at middle band, stop loss 2%, take profit 3%.",
  "aiAssetAnalysis.copilot.strategyExamples.code": "Turn my trading idea into a QuantDinger Python ScriptStrategy with trend filter, entries/exits, position sizing, stop/take-profit, logs, and validation steps.",
  "aiAssetAnalysis.copilot.strategyPrompt.designFor": "Design a strategy for {target}.",
  "aiAssetAnalysis.copilot.strategyPrompt.selectedIdea": "Selected prompt idea:",
  "aiAssetAnalysis.copilot.strategyPrompt.preferences": "My idea / preferences:",
  "aiAssetAnalysis.copilot.strategyPrompt.timeframe": "Timeframe",
  "aiAssetAnalysis.copilot.strategyPrompt.riskProfile": "Risk profile",
  "aiAssetAnalysis.copilot.strategyPrompt.signals": "Signals or logic I want to use",
  "aiAssetAnalysis.copilot.strategyPrompt.avoid": "Behaviors I want to avoid",
  "aiAssetAnalysis.copilot.strategyPrompt.generateNow": "If there is enough information, generate a runnable draft now. Use conservative defaults for missing parameters and clearly list defaults and tunable items.",
  "aiAssetAnalysis.copilot.strategyPrompt.targetIndicator": "Target type: Strategy R&D. Prefer an indicator-strategy draft that supports chart display and backtesting, with parameters, buy/sell signals, stop/take-profit, and invalidation conditions.",
  "aiAssetAnalysis.copilot.strategyPrompt.targetScript": "Target type: Script Strategy. It should fit Python ScriptStrategy with state management, order logic, risk parameters, error handling, and logging.",
  "aiAssetAnalysis.copilot.strategyPrompt.targetTemplate": "Target type: Template Strategy. First decide whether grid, trend, DCA, martingale, or another template strategy type fits best, then explain why and list key parameters.",
...
export default {
  ...
  'profile.mfa.disabled': "Not enabled",
  'profile.mfa.desc': "Bind Google Authenticator, Microsoft Authenticator, 1Password, or another authenticator app. After binding, risky password logins require a 6-digit code.",
  'profile.mfa.systemDisabled': "Authenticator MFA is currently disabled by the system.",
  'profile.mfa.boundAt': "Bound at",
  'profile.mfa.enable': "Enable MFA",
  'profile.mfa.disable': "Disable MFA",
  'profile.mfa.setupTitle': "Bind Authenticator App",
  'profile.mfa.scanHint': "Scan the QR code with your authenticator app, then enter the 6-digit code to finish setup.",
  'profile.mfa.stepScanDesc': "Open Google Authenticator, Microsoft Authenticator, 1Password, or another authenticator app.",
  'profile.mfa.stepScan': "Scan the QR code",
  'profile.mfa.setupIntroTitle': "Finish setup step by step",
  'profile.mfa.manualKey': "Manual setup key",
  'profile.mfa.verifyCode': "Verification code",
  'profile.mfa.codePlaceholder': "Enter a 6-digit code or recovery code",
  'profile.mfa.confirmEnable': "Confirm Enable",
  'profile.mfa.recoveryTitle': "Save Recovery Codes",
  'profile.mfa.recoveryHint': "These recovery codes are shown only once. Store them somewhere safe; you can use them to sign in if your authenticator is unavailable.",
  'profile.mfa.disableTitle': "Disable MFA",
  'profile.mfa.disableHint': "After disabling MFA, risky password logins will no longer ask for an authenticator code. Enter your current 6-digit code to confirm.",
  'profile.mfa.codeRequired': "Please enter the verification code",
  'profile.mfa.featureApp': "Works with common apps",
  'profile.mfa.featureRisk': "Checks new devices/locations",
  'profile.mfa.featureRecovery': "Recovery codes included",
