...
const locale = {
  ...
  'menu.dashboard.strategyCenter': 'Data Center',
  'strategyCenter.title': 'Data Center',
  'strategyCenter.subtitle': 'Indicator strategies, script strategies, and template strategies share one backtest & live engine',
  ...
  'strategyCenter.header.badge': 'Data & live hub',
  ...
  'strategyCenter.header.openIde': 'Indicator IDE',
  ...
  'community.tabScriptTemplates': 'Strategy templates',
  ...
  'settings.market.desc.Forex': 'FX pairs and precious metals routed through FX data sources and MT5.',
  ...
  'settings.field.ALLOW_LOCAL_DESKTOP_BROKERS': 'Allow IBKR / MT5 (local desktop brokers)',
  'settings.field.ENABLED_MARKETS': 'Enabled Markets',
  ...
  'settings.desc.ALLOW_LOCAL_DESKTOP_BROKERS': 'Allow local desktop broker integrations such as IBKR and MT5. Disable this for cloud-only deployments.',
  'settings.desc.ENABLED_MARKETS': 'Choose which market modules are visible and usable across research, strategy, and live trading workflows.',
  ...
  'brokerAccounts.cryptoSection.subtitle': 'These accounts are stored as encrypted credentials in the database and used by template strategies and live strategies. Supports Binance / OKX / Bybit / HTX / Bitget / Coinbase / Kraken / KuCoin / Gate.io / Bitfinex / Deepcoin.',
