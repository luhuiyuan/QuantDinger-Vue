...
const locale = {
  ...
  "strategyCenter.header.createStrategyV2": "Create Strategy API V2",
  ...
  "trading-assistant.editor.aiSuggestionImprovePrompt": "Improve the current script structure and logs. Keep symbol, direction, investment amount, and leverage controlled by the run panel, not context.params.",
...
export default {
  ...
  "strategyIde.indicatorConvertBoundary": "The conversion creates Strategy API V2 code. Symbol, capital, market type, leverage and direction are still configured in the run panel.",
