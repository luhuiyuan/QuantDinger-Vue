...
const locale = {
  ...
  'strategyCenter.subtitle': 'Indicator strategies, script strategies, and bots share one backtest & live engine',
  ...
  'strategyCenter.card.bot.title': 'Trading Bot',
  ...
  'strategyCenter.card.bot.action': 'Create bot',
  ...
  'strategyCenter.header.createBot': 'Create bot',
  ...
  'strategyCenter.library.bots': 'Trading bots',
  ...
  'strategyCenter.stats.bot': 'Bots',
  'strategyCenter.stats.running': 'Running',
  'strategyCenter.flowHintTitle': 'Recommended path',
  'strategyCenter.flowHintDesc': 'Validate signals in Indicator IDE → create an indicator strategy; need stateful logic → script strategy; common patterns → trading bot.',
  ...
  'strategyCenter.backtest.botHintTitle': 'Bot backtest note',
  'strategyCenter.backtest.botHintDesc': 'Bots run on script templates; results are bar-replay simulations and may differ from live resting-order engines (e.g. grid).',
  ...
  'community.botPresetInfo': 'About this preset',
  ...
  'trading-bot.action.openMarketplace': 'Browse bot marketplace',
  'trading-bot.publish.title': 'Publish bot preset',
  ...
  'trading-bot.publish.hint': 'Only parameter templates are published (no API keys). After review, it appears under Strategy Market → Bot presets.',
  'trading-bot.publish.defaultDescription': 'Parameter template based on {type} bot',
  'trading-bot.publish.success': 'Submitted for review. It will appear under Bot presets once approved.',
  ...
  'dashboard.setupGuide.desc': 'Indicator strategies, script strategies, and trading bots share this overview. Create and start one from the workspace to see positions, trades, and performance here.',
  'dashboard.setupGuide.path': 'Path: Data Center → Workspace → pick a type (Indicator / Script / Bot) → start Live',
